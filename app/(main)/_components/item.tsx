...
export const Item = ({
    ...
    return(
        <div
            ...
            className={cn(
                "group min-h-[27px] text-sm py-1 pr-3 w-full flex hover:bg-primary/5 items-center text-muted-foreground font-medium",
        ...
        >
            ...
            {isSearch&&(
                ...
                h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px]
